...
{
	SkillNormalTackle UMETA(DisplayName = "Tackle"),	//몸통박치기 - 염버니
	SkillNormalPound UMETA(DisplayName = "Pound"),	//막치기 - 울머기
	SkillNormalScratch UMETA(DisplayName = "Scratch"),	//할퀴기 - 흥나숭
